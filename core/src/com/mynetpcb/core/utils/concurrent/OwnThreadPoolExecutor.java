...
/*
 * Fix ThreadPoolExecutor by removing the Runtime Permission check
 */
 ...
 * @author Doug Lea
 */
public class OwnThreadPoolExecutor extends AbstractExecutorService {
...
//        new RuntimePermission("modifyThread");
     ...
     */
    private volatile OwnRejectedExecutionHandler handler;
     ...
     */
    private static final OwnRejectedExecutionHandler defaultHandler =
        new AbortPolicy();
     ...
     */
    public OwnThreadPoolExecutor(int corePoolSize,
                              int maximumPoolSize,
                              long keepAliveTime,
                              TimeUnit unit,
    ...
    public OwnThreadPoolExecutor(int corePoolSize,
                              ...
                              TimeUnit unit,
                              BlockingQueue<Runnable> workQueue,
                              OwnRejectedExecutionHandler handler) {
        this(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,
...
//    }
     ...
     * is discarded.
     */
    public static class CallerRunsPolicy implements OwnRejectedExecutionHandler {
        /**
         ...
         */
        public void rejectedExecution(Runnable r, OwnThreadPoolExecutor e) {
            if (!e.isShutdown()) {
                r.run();
            }
        }
     ...
     */
    public static class AbortPolicy implements OwnRejectedExecutionHandler {
        /**
     ...
     * rejected task.
     */
    public static class DiscardPolicy implements OwnRejectedExecutionHandler {
        /**
     ...
     */
    public static class DiscardOldestPolicy implements OwnRejectedExecutionHandler {
        /**
