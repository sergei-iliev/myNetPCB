...
private String demo="c:\\sergei\\java\\myNetPCB\\deploy\\workspace\\boards\\demo\\demo.xml";
...
//       processor.process(context,board, Layer.BOARD_EDGE_CUTS);
//        
//       CommandCutOutProcessor command=new CommandCutOutProcessor(context);
//       command.process(context,board, Layer.BOARD_EDGE_CUTS);
//        
