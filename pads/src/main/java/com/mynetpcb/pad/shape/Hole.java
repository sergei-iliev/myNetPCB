...
public class Hole extends HoleShape implements Externalizable{
    ...
    public static class Memento extends AbstractMemento<Footprint,Hole>{
        private double x,y;
        private double r;
        ...
        @Override
        public void saveStateFrom(Hole shape) {
        ...
        public void loadStateTo(Hole shape) {
        ...
        public boolean isSameState(Unit unit) {
            ...
            Hole other=(Hole)unit.getShape(getUUID());
